...
% --- Microtypography & paragraph alignment ---
\usepackage[final]{microtype}
\microtypesetup{tracking=true,protrusion=false}
\usepackage{ragged2e} % improved ragged-right with sensible hyphenation
...
\titleformat{\section}{\sffamily\bfseries\LARGE\color{Ink}\raggedright}{\thesection}{1em}{}
\titlespacing*{\section}{0pt}{24pt}{12pt}
\titleformat{\subsection}{\sffamily\bfseries\Large\color{Ink}\raggedright}{\thesubsection}{1em}{}
...
% Left-align (ragged-right) all body text; prevent mid-word hyphenation and overflow
\AtBeginDocument{%
  \RaggedRight
  \hyphenpenalty=10000
